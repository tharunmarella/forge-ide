                                            ...
                                            for tc_val in tcs {
                                                ...
                                                let is_safe_command = if tc_name == "execute_command" || tc_name == "execute_background" {
                                                    ...
                                                    cmd_lower.starts_with("npm run ")
                                                        ...
                                                        // Git: read-only and standard workflow commands are safe
                                                        ...
                                                        || cmd_lower.starts_with("git fetch")
                                                        || cmd_lower.starts_with("git pull")
                                                        || cmd_lower.starts_with("git push")
                                                        || cmd_lower.starts_with("git remote")
                                                        || cmd_lower.starts_with("git tag")
                                                        || cmd_lower.starts_with("git merge")
                                                        || cmd_lower.starts_with("git rebase")
                                                        || cmd_lower.starts_with("git cherry-pick")
                                                        || cmd_lower.starts_with("gh ")
                                                        // Shell: read-only and safe utilities
